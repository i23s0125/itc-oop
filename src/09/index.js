...
class CheckboxInput extends BaseInput {
  render(container) {
    this.element = document.creatrElement('input');
    this.element.type = 'checkbox';
    this.element.checked = tgis.value === true;
  ...
  subscribe(updater) {
    this.subscribe.forEach(this.subscribe = this.subscribe(this.value));
  }
}
